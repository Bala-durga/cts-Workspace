...
public class Movies implements Serializable /* implements Comparable<Book> */ {
	...
	public Movies(String mvId, String mvName, String mvHero,LocalDate releaseDate, int collection) {
		super();
		this.mvId = mvId;
		this.mvName = mvName;
		this.mvHero=mvHero;
